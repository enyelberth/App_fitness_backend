...
exports.SubCategoryProductService = void 0;
...
class SubCategoryProductService {
    ...
    findAll() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const category = yield this.prisma.subCategoryProduct.findMany();
                return {
                    status: 200,
                    data: category,
                };
    ...
    findOne(id) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const dato = yield this.prisma.subCategoryProduct.findUnique({
                    where: { id },
                });
                return {
                    status: 200,
...
exports.SubCategoryProductService = SubCategoryProductService;
